...
# 1. Create serviceaccountkey.json cleanly
...
print("Created serviceaccountkey.json successfully!")

# 2. Clean up .env by removing the broken FIREBASE_SERVICE_ACCOUNT line
if os.path.exists(".env"):
    with open(".env", "r", encoding="utf-8") as f:
        env_lines = f.readlines()
    
    cleaned_lines = [l for l in env_lines if not l.startswith("FIREBASE_SERVICE_ACCOUNT")]
