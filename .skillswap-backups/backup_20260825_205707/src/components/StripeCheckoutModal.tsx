...
const CREDIT_PACKAGES = [
  { id: 'p1', credits: 1, price: 5, label: 'Single Session', popular: false },
  { id: 'p2', credits: 3, price: 12, label: 'Standard Bundle (Save $3)', popular: true },
  { id: 'p3', credits: 7, price: 25, label: 'Master Scholar (Save $10)', popular: false },
];
...
export const StripeCheckoutModal: React.FC<StripeCheckoutModalProps> = ({
  ...
  const handlePayWithStripe = (e: React.FormEvent) => {
    e.preventDefault();
                ...
                <div className="grid grid-cols-3 gap-3">
                  {CREDIT_PACKAGES.map((pkg) => (
                    ...
                    >
                      ...
                      <p className="text-xs font-bold text-white mt-1">${pkg.price}</p>
                ...
                <div className="p-3.5 bg-slate-950 border border-slate-800 rounded-2xl space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-slate-900 border border-slate-800 rounded-xl text-xs text-white font-mono focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      required
                    />
                  </div>
                ...
                >
                  {isProcessing ? (
                    ...
                    <>
                      ...
                      <span>Pay ${selectedPackage.price}.00 for +{selectedPackage.credits} Credit(s)</span>
                    </>
                  )}
                </button>
              </div>
