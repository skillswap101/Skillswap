...
lines = [line for line in env_content.splitlines() if not line.startswith("FIREBASE_SERVICE_ACCOUNT=")]
lines.append(f"FIREBASE_SERVICE_ACCOUNT='{env_json_string}'")

with open(env_path, "w", encoding="utf-8") as f:
    f.write("\n".join(lines) + "\n")

print("Successfully injected FIREBASE_SERVICE_ACCOUNT into your .env file!")
